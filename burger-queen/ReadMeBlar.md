...
Investigar cómo hacer el CRUD con Firebase+React.
Spike sobre roles de usuario.
Investigar qué son diagramas de estados (en REACT-JS).
Investigar cómo pintar los JSONs (en REACT-JS).
Spike con recursos del README.
Comparar las carpetas burgerqueen y burger-queen, con ayuda de algún coach.
